...
namespace SistemaTurnos.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IdUsuario,VEmail,VPass,VRut,VNombre,VApellido,IdTipoUsuario")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IdUsuario,VEmail,VPass,VRut,VNombre,VApellido,IdTipoUsuario")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
